...
import com.example.weatherapp.presentation.extentions.formattedFullDate
import com.example.weatherapp.presentation.extentions.formattedShortDayOfWeek
import com.example.weatherapp.presentation.extentions.tempToFormattedString
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                ...
                onClickChangeFavouriteStatus = { component.onChangeFavouriteStatus() }
            )
        },
        modifier = Modifier
            .fillMaxSize()
...
@Composable
private fun UpcommingWeather(upcoming: List<Weather>) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(24.dp),
